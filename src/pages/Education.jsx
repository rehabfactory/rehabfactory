...
import premiumHeroImg from '../assets/hero_premium.webp';
import aboutHeroImg from '../assets/about_hero.webp';
import trenchesImg from '../assets/about_trenches.webp';
import serviceHeroImg from '../assets/service_hero.webp';
import diffHeroImg from '../assets/the-difference-hero.webp';

gsap.registerPlugin(ScrollTrigger);

const techniques = [
  { num: '01', title: 'Collating Information', focus: 'Gathering relevant data across medical history, symptoms, and functional capacity to form a complete picture.', img: aboutHeroImg },
  { num: '02', title: 'Forming A Diagnosis', focus: 'Analysing the collated information to pinpoint the root cause of your pain or dysfunction.', img: trenchesImg },
  { num: '03', title: 'Action Plan', focus: 'Mapping out a step-by-step strategy for treatment, rehabilitation, and long-term recovery.', img: serviceHeroImg },
  { num: '04', title: 'Expected Timeframes', focus: 'Setting realistic expectations for healing and return to full function based on evidence and clinical experience.', img: diffHeroImg },
];
    ...
    <div ref={containerRef} className="overflow-x-hidden bg-primary">
      ...
      <section className="relative min-h-[90vh] flex items-center bg-primary overflow-hidden border-b border-white/10">
        <div className="absolute inset-0 z-0">
          <img src={premiumHeroImg} alt="Education Hero" className="w-full h-full object-cover" />
        ...
        <div className="container relative z-10 pt-24 md:pt-32">
          <div className="max-w-3xl">
            ...
            <h1 className="hero-anim font-display font-bold leading-[0.85] tracking-normal uppercase text-white mb-8" style={{ fontSize: 'clamp(42px, 11vw, 150px)' }}>
              Empowering<br /><span className="text-secondary">Education.</span>
            </h1>
            <p className="hero-anim text-2xl md:text-3xl text-white/80 font-poppins font-light leading-relaxed max-w-2xl mb-12 drop-shadow-lg">
              Knowledge is the first step to recovery. Understanding your body is more powerful than following instructions blindly.
            </p>
        ...
        <div className="container reveal">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h2 className="font-display font-bold text-5xl md:text-7xl lg:text-[100px] uppercase tracking-normal leading-[0.85] text-white mb-10">
              Four Pillars of <br className="hidden md:block" />
            ...
            <p className="text-slate-400 font-poppins text-xl md:text-3xl leading-tight font-normal max-w-3xl mx-auto mb-16">
              Our clinical framework is built on transparency. We demystify pain and biomechanics so you take control of your health.
            </p>
        ...
        <div className="container reveal-fade-up">
          <div className="max-w-5xl mx-auto bg-primary rounded-[32px] md:rounded-[64px] p-10 md:p-20 lg:p-24 text-center shadow-[0_30px_80px_rgba(0,0,0,0.2)] overflow-hidden relative">
            ...
            <div className="relative z-10">
              <span className="text-[13px] md:text-[15px] font-black tracking-[0.4em] text-secondary uppercase font-poppins block mb-6">YOUR RECOVERY JOURNEY</span>
              <h2 className="font-display font-bold text-4xl md:text-6xl lg:text-7xl uppercase tracking-normal leading-[0.9] mb-8 text-white">
                Take the first step towards<br />understanding your body.
              </h2>
              <p className="text-white/70 font-poppins text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-12">
                Stop guessing. Get a clear diagnosis and a structured plan designed exclusively for your lifestyle.
              </p>
              <a href="https://book.nookal.com/bookings/book/e1AbE0C0-AD43-9c68-3AFa-cEFB7EE18217/location" target="_blank" rel="noopener noreferrer"
