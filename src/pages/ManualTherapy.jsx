...
const techniques = [
  { num: '01', title: 'Soft Tissue Massage', focus: 'Targeted release of muscle tension, soreness, and trigger points to restore normal function.', img: manualTherapyImg },
  { num: '02', title: 'Joint Mobilisation', focus: 'Controlled, passive movement of joint surfaces to reduce pain and immediately restore range of motion.', img: diffHeroImg },
  { num: '03', title: 'Dry Needling', focus: 'Fine filiform needles inserted into myofascial trigger points to reduce localised muscle tension and pain.', img: sportsTapingImg },
  { num: '04', title: 'Sports Taping', focus: 'Restricts or facilitates joint movement depending on injury type, promoting better recovery for all patients.', img: trenchesImg },
];
    ...
    <div ref={containerRef} className="overflow-x-hidden bg-primary">
      ...
      <section className="relative min-h-[90vh] flex items-center bg-primary overflow-hidden border-b border-white/10">
        <div className="absolute inset-0 z-0">
          <img src={serviceHeroImg} alt="Manual Therapy Hero" className="w-full h-full object-cover" />
        ...
        <div className="container relative z-10 pt-24 md:pt-32">
          <div className="max-w-3xl">
            ...
            <p className="hero-anim text-2xl md:text-3xl text-white/80 font-poppins font-light leading-relaxed max-w-2xl mb-12 drop-shadow-lg">
              Hands-on techniques aim to provide quick pain relief and improve movement — preparing your body to engage fully with exercise rehabilitation.
            </p>
        ...
        <div className="container reveal">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-slate-400 font-poppins text-xl md:text-3xl leading-tight font-normal max-w-3xl mx-auto mb-16">
              At Rehab Factory Physiotherapy (RFP), manual therapy is not the whole treatment — it is only the beginning that prepares your body for active exercise rehabilitation.
            </p>
          ...
          <div className="max-w-5xl mx-auto bg-primary rounded-[32px] md:rounded-[64px] p-10 md:p-20 lg:p-24 text-center shadow-[0_30px_80px_rgba(0,0,0,0.2)] overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/70 font-poppins text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-12">
                We reduce pain and restore movement first — then build strength and functional performance on our clinic gym floor.
              </p>
              <a href="https://book.nookal.com/bookings/book/e1AbE0C0-AD43-9c68-3AFa-cEFB7EE18217/location" target="_blank" rel="noopener noreferrer"
